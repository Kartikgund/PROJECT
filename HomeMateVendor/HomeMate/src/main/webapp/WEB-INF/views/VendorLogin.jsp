                                    ...
                                    <div class="navbar-nav ml-auto">
                                        ...
                                        <div class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="/customer" class="dropdown-item">Customer Login</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="form-group col">
                ...
                <a href="/vendor" class="btn btn-primary btn-block" type="submit" id="btn-signup"><i class="fas fa-user-plus"></i> Sign up New Account</a>
